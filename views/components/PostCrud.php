    ...
    <div class="container">
            ...
            <div>
                <form action="">
                    ...
                    <div class="form-group">
                        ...
                        <select id="categorias" class="form-control" v-model="activemodel.categorias" multiple>
        ...
        <table class="table" id="my-table">
            ...
            <tr v-for="(model,key) in models" v-bind:key="model[modelfields[0]]">
                ...
                <td>
                    <div v-for="cat in model.categorias">
                    {{cat.nombre}}
                    </div>
                </td>
                <td>
